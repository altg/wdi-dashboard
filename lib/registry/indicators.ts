...
// Extended WDI indicators — basic metadata only (no driverIndicators, no events).
// Deep-dive pages work but show no driver table.
export const EXTENDED_INDICATORS: Indicator[] = [
  // Health
  {
    code: "SH.STA.STNT.ZS",
  ...
  {
    code: "SI.POV.URHC",
    name: "Poverty headcount ratio at urban poverty line (% of urban population)",
  ...
  {
    code: "SI.POV.RUHC",
    name: "Poverty headcount ratio at rural poverty line (% of rural population)",
  ...
  {
    code: "IQ.CPA.FINS.XQ",
    name: "CPIA financial sector rating",
    unit: "rating (1–6)",
    source: "World Bank Country Policy and Institutional Assessment",
    topic: "Governance",
    sdgGoal: 16,
  ...
  {
    code: "IQ.CPA.MACR.XQ",
    name: "CPIA macroeconomic management rating",
    unit: "rating (1–6)",
    source: "World Bank Country Policy and Institutional Assessment",
    topic: "Governance",
    sdgGoal: 16,
  ...
  {
    code: "IQ.CPA.PUBS.XQ",
    name: "CPIA quality of public administration rating",
    unit: "rating (1–6)",
    source: "World Bank Country Policy and Institutional Assessment",
    topic: "Governance",
    sdgGoal: 16,
...
export const INDICATOR_MAP = new Map<string, Indicator>(
  [...INDICATORS, ...EXTENDED_INDICATORS].map((ind) => [ind.code, ind])
);
